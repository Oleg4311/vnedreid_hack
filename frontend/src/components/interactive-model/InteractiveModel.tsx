  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        {/* Interactive hit areas and fills */}
        {ZONES.map(z => (
          <polygon
            key={z.id}
            data-part={z.id}
            points={z.points}
            fill={hovered === z.id ? getColor(statusMap[z.id].score) : 'transparent'}
      ...
      {hovered && (
        ...
        >
          ...
          <div className={styles.tooltipBody}>
            ...
            Статус: {statusMap[hovered].status}<br />
            Уровень: {statusMap[hovered].score ?? '—'}
          </div>
        </div>
      )}
    </div>
