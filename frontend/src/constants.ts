...
export const ZONES: { id: PartId; points: string }[] = [
  ...
  { id: 'left_door_front', points: '60,110 60,170 70,170 70,110' },
  { id: 'right_door_front', points: '136,110 136,170 146,170 146,110' },
  { id: 'left_door_rear', points: '60,170 60,240 70,240 70,170' },
  { id: 'right_door_rear', points: '136,170 136,240 146,240 146,170' },
  { id: 'left_mirror', points: '58,120 50,122 58,130' },
  { id: 'right_mirror', points: '148,120 156,122 148,130' },
];
